...
processed_metadata_dictionary=preprocess_metadata_into_subtrees(simple_dictionary)

def preprocess_incoming_message(topic_name, message):
    return harmonize(process_topic_name(topic_name,processed_metadata_dictionary), message)

preprocess_incoming_message("marija/yesy/stp","True")